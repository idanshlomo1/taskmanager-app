...
const Tasks = ({ title, tasks }: Props) => {
    ...
    const skeletonArray = Array(6).fill(0); // Adjust the number of skeletons based on your grid

    return (
        <div className='w-full border rounded-lg p-8 flex flex-col  md:h-[70vh]'>
